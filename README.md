...
- <img src="https://img.shields.io/github/stars/bmw8080/laya-decision-api?style=social" height="17" align="texttop"/> [laya-decision-api](https://github.com/bmw8080/laya-decision-api) - Self-hosted FastAPI service around the Laya System-1 decision model: offline classification / triage / routing decisions with probabilities and confidence, no text generation.
